# Scorekeeper — Antigravity Agent Instructions

This file contains project-scoped rules and instructions for Antigravity, imported from `CLAUDE.md` and `.github/copilot-instructions.md`.
...
**Rules:**
- Always prefix shell commands with `rtk` (e.g. `rtk git status`, `rtk ./gradlew test`) to minimize token consumption.
